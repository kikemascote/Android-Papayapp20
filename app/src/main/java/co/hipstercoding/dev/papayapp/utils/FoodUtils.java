...
import static co.hipstercoding.dev.papayapp.utils.StaticVarsUtils.NOTIFICATION_PERIODICITY_KEY;
...
public class FoodUtils {
    ...
    public static Food[] sortByExpirationDate(Context context) {
        ...
        foods = foodList.toArray(new Food[0]);
    ...
    public static boolean foodAboutToExpire(String expireDateString, Context context) {
        ...
        try {
            diff = Objects.requireNonNull(expireDate).getTime() - currentDate.getTime();
        } catch (Exception e) {
        ...
        return daysLeft < periodicity && daysLeft >= 0;
