...
import co.hipstercoding.dev.papayapp.data.FoodContract;
...
// --Commented out by Inspection STOP (08/07/2019 03:54 AM)
    ...
    public Food[] queryFoods(String queryString) {
        ...
        int idCol = Objects.requireNonNull(foodsCursor).getColumnIndex(FoodContract.FoodEntry._ID);
        int nameCol = foodsCursor.getColumnIndex(FoodContract.FoodEntry.COLUMN_FOOD_NAME);
        int unitCol = foodsCursor.getColumnIndex(FoodContract.FoodEntry.COLUMN_FOOD_UNIT);
        int quantityCol = foodsCursor.getColumnIndex(FoodContract.FoodEntry.COLUMN_FOOD_QUANTITY);
        int categoryCol = foodsCursor.getColumnIndex(FoodContract.FoodEntry.COLUMN_FOOD_CATEGORY);
    ...
    public void insertSampleDataSet() {
        ...
        cvFood.put(FoodContract.FoodEntry.COLUMN_SECTION_ID, Objects.requireNonNull(uri).getPathSegments().get(1));//get the id of the added section
    ...
    public Food getFoodById(int foodId) {
        ...
        Objects.requireNonNull(foodCursor).moveToFirst();
    ...
    public Section getSectionById(int sectionId) {
        ...
        Objects.requireNonNull(sectionCursor).moveToFirst();
    ...
    public void deleteAllFoodsInsideSection(int sectionId) {
        ...
        for (Food food : foods) {
            if (food.sectionId == sectionId) {
                deleteFoodById(food.foodId);
            }
        }
